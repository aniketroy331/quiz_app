        ...
        {subjectsConfig.map((subjectItem) => (
          ...
          >
            <div className="flex items-center justify-start w-full">
              ...
              {/* 🟡 UPDATED: Changed from text-left to flex-col layout */}
              <div className="flex flex-col text-left gap-1"> {/* 🟡 UPDATED */}
                <span className="text-lg font-semibold">{subjectItem.name}</span>
                
                {/* 🟡 UPDATED: Made description text wrap responsively */}
                <p className="text-xs text-muted-foreground group-hover:text-primary-foreground/80 whitespace-normal break-words"> {/* 🟡 UPDATED */}
